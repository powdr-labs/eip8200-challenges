...
theorem exec_mainLength_success (yst : EvmState)
    ...
    Interp.execStmt Challenge.YulProof.ClosedEvm.exec 16 mainFuns [] yst
  ...
  simp [mainLengthStmt, Compilation.referenceCompiledBlock,
    ...
    Interp.evalExpr, Interp.evalArgs, Challenge.YulProof.ClosedEvm.exec,
    Challenge.YulProof.ClosedEvm.builtinFn, stepOp, bin, un, rd0,
    EVM.litValue, b2w, Dialect.zero, hsize]

theorem exec_mainStores (yst : EvmState) :
    Interp.execStmts Challenge.YulProof.ClosedEvm.exec 32 mainFuns [] yst
