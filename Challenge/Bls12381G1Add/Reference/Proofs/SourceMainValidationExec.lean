...
theorem exec_mainPadding (yst : EvmState) :
    Interp.execStmt Challenge.YulProof.ClosedEvm.exec 16 mainFuns []
...
private theorem eval_fpValid62 (hi lo : U256) (yst : EvmState) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 62 mainFuns
      [("hi", hi), ("lo", lo)] yst
...
private theorem eval_fpValid_mload62 (yst : EvmState)
    ...
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 62 mainFuns [] yst
  ...
  have hargs :
      Interp.evalArgs Challenge.YulProof.ClosedEvm.exec 61 mainFuns [] yst
          [.builtin .mload [.lit (.number hiOffset)],
            .builtin .mload [.lit (.number loOffset)]] =
        Interp.evalArgs Challenge.YulProof.ClosedEvm.exec 61 mainFuns
...
private theorem eval_fpValid_mload63 (yst : EvmState)
    (hiOffset loOffset : Nat)
    (hhi : hiOffset < 2 ^ 256) (hlo : loOffset < 2 ^ 256) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 63 mainFuns [] yst
      (validCall hiOffset loOffset) =
      .ok (.vals
        [fpValidValue (loadWord yst.memory hiOffset)
          (loadWord yst.memory loOffset)]
        (afterTwoLoads yst hiOffset loOffset)) := by
  have hargs :
      Interp.evalArgs Challenge.YulProof.ClosedEvm.exec 62 mainFuns [] yst
          [.builtin .mload [.lit (.number hiOffset)],
            .builtin .mload [.lit (.number loOffset)]] =
...
private theorem eval_fpValid_mload (yst : EvmState)
    (hiOffset loOffset : Nat)
    (hhi : hiOffset < 2 ^ 256) (hlo : loOffset < 2 ^ 256) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 64 mainFuns [] yst
      (validCall hiOffset loOffset) =
      .ok (.vals
        [fpValidValue (loadWord yst.memory hiOffset)
          (loadWord yst.memory loOffset)]
        (afterTwoLoads yst hiOffset loOffset)) := by
  have hargs :
      Interp.evalArgs Challenge.YulProof.ClosedEvm.exec 63 mainFuns [] yst
          [.builtin .mload [.lit (.number hiOffset)],
            .builtin .mload [.lit (.number loOffset)]] =
...
private theorem eval_validPair (yst : EvmState)
    ...
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 66 mainFuns [] yst
  ...
  simp [Challenge.YulProof.ClosedEvm.exec,
    Challenge.YulProof.ClosedEvm.builtinFn, stepOp, bin, afterTwoLoads,
    touchMemory_memory]
...
private theorem eval_validPair65 (yst : EvmState)
    ...
    (hhi0 : hi0 < 2 ^ 256) (hlo0 : lo0 < 2 ^ 256)
    (hhi1 : hi1 < 2 ^ 256) (hlo1 : lo1 < 2 ^ 256) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 65 mainFuns [] yst
      (validPair hi0 lo0 hi1 lo1) =
      .ok (.vals
        [fpValidValue (loadWord yst.memory hi0) (loadWord yst.memory lo0) &&&
          fpValidValue (loadWord yst.memory hi1) (loadWord yst.memory lo1)]
...
private theorem eval_canonicalRaw (yst : EvmState) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 68 mainFuns []
...
private theorem eval_mainCanonicalCondition (yst : EvmState) :
    Interp.evalExpr Challenge.YulProof.ClosedEvm.exec 70 mainFuns []
  ...
  simp [Challenge.YulProof.ClosedEvm.exec,
    Challenge.YulProof.ClosedEvm.builtinFn, stepOp, un, b2w]
...
private theorem exec_invalidBlock (yst : EvmState) :
    Interp.execStmt Challenge.YulProof.ClosedEvm.exec 70 mainFuns [] yst
      (.block [.exprStmt (.builtin .invalid [])]) =
      .ok ([], mainInvalidState yst, .halt) := by
  simp [Interp.execStmt, Interp.execStmts, Interp.evalExpr,
    Interp.evalArgs, mainInvalidState, Challenge.YulProof.ClosedEvm.exec,
    Challenge.YulProof.ClosedEvm.builtinFn, stepOp, restore]

theorem exec_mainCanonical (yst : EvmState) :
    Interp.execStmt Challenge.YulProof.ClosedEvm.exec 71 mainFuns []
  ...
  · have hbool : b2w (mainCanonicalValue yst = 0) = (1 : U256) := by
    ...
    change (if (1 : U256) =
        Dialect.zero Challenge.YulProof.ClosedEvm.exec.toDialect then
      .ok ([], mainAfterCanonicalReads yst, .normal)
    else Interp.execStmt Challenge.YulProof.ClosedEvm.exec 70 mainFuns []
      (mainAfterCanonicalReads yst)
      (.block [.exprStmt (.builtin .invalid [])])) = _
    rw [if_neg (by decide : (1 : U256) ≠
      Dialect.zero Challenge.YulProof.ClosedEvm.exec.toDialect)]
