...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| [Reference Yul](Reference/reference.yul) | 4687 | 11850 | 11880 | 11912 | 12160 | 702066 | 699670 | 1449538 | 644.24× | measured artifact |
...
scripts/check-bls12381-g1add-gas-report.sh
```
...
[`foundry/test/Bls12381G1AddGas.t.sol`](../../foundry/test/Bls12381G1AddGas.t.sol)
uses the repository's calibrated frame-gas probe for the generated leaderboard
and requires exact agreement with its checked-in measurements.
