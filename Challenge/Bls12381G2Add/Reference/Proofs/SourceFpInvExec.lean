import Challenge.Bls12381G2Add.Reference.Proofs.SourceFpInvBody

set_option warningAsError true

/-! # Frozen G2ADD `fpInv` execution -/
...
/-- The G2 frozen helper executes the complete source inversion schedule. -/
