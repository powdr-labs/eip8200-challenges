import Challenge.Bls12381G2Add.Reference.Proofs.SourceFpMulStart

set_option warningAsError true

/-! # Frozen G2ADD `fpMul` modulus store and MODEXP call -/
...
/-- The fixed-gas MODEXP call succeeds on the exact 241-byte input. -/
