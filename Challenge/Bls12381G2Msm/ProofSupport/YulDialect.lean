...
/-! Lightweight source-dialect boundary for the G2MSM executable artifact. -/

namespace Challenge.Bls12381G2Msm.ProofSupport.Yul
...
end Challenge.Bls12381G2Msm.ProofSupport.Yul
