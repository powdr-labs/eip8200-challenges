import Challenge.Bls12381G2Msm.Reference.Proofs.SourceFp2MulImag
import Challenge.EvmProof.ExecSound

set_option warningAsError true

/-! Big-step composition of frozen G2MSM `fp2Mul`. -/
...
theorem step_fp2MulBody (yst : EvmState) (out a b : U256) :
    ExecStmt Challenge.EvmProof.modexpExec.toDialect fp2MulFuns
      ...
      (fp2MulBodyResultEnv yst out a b) (fp2MulFinalState yst out a b)
      .normal := by
