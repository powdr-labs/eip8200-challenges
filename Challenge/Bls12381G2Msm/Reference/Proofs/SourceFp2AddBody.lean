import Challenge.Bls12381G2Msm.Reference.Proofs.SourceFpAddFuel65

set_option warningAsError true

/-! Second component and body of frozen G2MSM `fp2Add`. -/
...
def fp2AddC1Env (yst : EvmState) (out a b : U256) :
  ...
  VEnv.setMany (fp2AddC0Env yst out a b) ["\x00109", "\x00110"]
...
private def fp2AddCall1 : Expr Op :=
  .call "\x004"
    [.builtin .mload
      ...
      .builtin .mload
        [.builtin .add [.var "\x00108", .lit (.number 64)]],
      .builtin .mload
        [.builtin .add [.var "\x00108", .lit (.number 96)]]]

private theorem fp2AddStmt3_shape : fp2AddStmt3 =
    .assign ["\x00109", "\x00110"] fp2AddCall1 := by
  rfl
...
private theorem eval_fp2AddCall1 (yst : EvmState) (out a b : U256) :
  ...
  have hargs :
    ...
    simp [Interp.evalArgs, Interp.evalExpr, fp2AddAfterC1Reads,
      ...
      fp2AddC0Env, fp2AddInitialEnv, s,
