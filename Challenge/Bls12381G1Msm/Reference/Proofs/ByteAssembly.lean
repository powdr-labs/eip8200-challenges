import Challenge.Bls12381G1Msm.Reference.Proofs.ByteAssemblyChunks

set_option warningAsError true

/-!
# G1MSM byte-assembly reconstruction

All concrete instruction encoding is discharged in bounded chunk modules.
This module combines their opaque equalities using generic list identities.
-/
...
private theorem referenceInstructions_split_assemble :
  ...
  rw [← flatten_chunksOf 100 18 referenceInstructions,
...
private theorem referenceInstructionByteChunks_eq :
  ...
  rw [referenceInstructionBytesChunk0,
    ...
    referenceInstructionBytesChunk18]
