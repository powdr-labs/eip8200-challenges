...
/-! Loop-condition and right-shift boundaries for naive G1 scalar multiplication. -/
...
def scalarMulLoopEnv (bit scalar point out : U256) :
  ...
  [("\x00145", bit)] ++ scalarMulInitialEnv scalar point out

def scalarMulNextBit (bit : U256) : U256 :=
  bit >>> 1
