...
/-! The finite checker and its semantic bridge use only Lean's standard
quotient/propositional principles. -/

/-- info: 'Challenge.Bls12381G2Msm.Reference.Proofs.Compilation.referenceCheckedCert_valid' depends on axioms: [propext,
 Quot.sound] -/
#guard_msgs in
#print axioms referenceCheckedCert_valid

/-- info: 'Challenge.Bls12381G2Msm.Reference.Proofs.Compilation.referenceCheckedCert_bounded' depends on axioms: [propext,
 Quot.sound] -/
#guard_msgs in
#print axioms referenceCheckedCert_bounded

/-- info: 'Challenge.Bls12381G2Msm.Reference.Proofs.Compilation.referenceLengthLookup_entry' depends on axioms: [propext] -/
#guard_msgs in
#print axioms referenceLengthLookup_entry

/-- info: 'Challenge.Bls12381G2Msm.Reference.Proofs.Compilation.referenceAssembly_stack_bound' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
