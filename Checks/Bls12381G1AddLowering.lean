...
/-- info: 'Challenge.Bls12381G1Add.Reference.Proofs.Compilation.referenceLowerSucceeded' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
#print axioms referenceLowerSucceeded

/-- info: 'Challenge.Bls12381G1Add.Reference.Proofs.Compilation.referenceAssembly_lower' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
